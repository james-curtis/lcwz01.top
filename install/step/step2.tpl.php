...
if (phpversion() >= '5.4.0') {
	?>
<span><img src="images/correct.gif" /></span><?php 
} else {
	?>
<font class="red"><img src="images/error.gif" />&nbsp;无法安装</font><?php 
}
?>
</font></td>
                  </tr>
...
<span><img src="images/correct.gif" /></span><?php 
	...
	?>
<font class="red"><img src="images/error.gif" />&nbsp;不只持json,<a href="http://pecl.php.net/package/json" target="_blank">安装 PECL扩展</a></font><?php 
}
?>
</td>
                  </tr>
...
<span><img src="images/correct.gif" /></span><?php 
	...
	?>
<font class="red"><img src="images/error.gif" />&nbsp;不能下载模板和在线升级</font><?php 
}
?>
</td>
                  </tr>
...
if ($is_right) {
	...
	?>
			<a onClick="alert('当前配置不满足本程序安装需求，无法继续安装！');" class="x_btn pre">检测不通过</a>
 			<?php 
}
?>
