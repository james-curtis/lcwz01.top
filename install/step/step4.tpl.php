...
" class="input-text" />
			...
			<td><input name="dbuser" type="text" id="dbuser" value="<?php 
echo $username;
?>
" class="input-text" /></td>
			</tr>
			...
			<td><input name="dbpw" type="password" id="dbpw" value="<?php 
echo $password;
?>
" class="input-text" /></td>
			</tr>
			...
			<td><input name="dbname" type="text" id="dbname" value="<?php 
echo $database;
?>
" class="input-text" /></td>
			</tr>
